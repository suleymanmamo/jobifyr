  ...
  footer.innerHTML = `
    <div class="footer-content">
      <div class="footer-left">
        <span class="footer-logo">Jobifyr</span>
        <span class="footer-copy">&copy; ${new Date().getFullYear()} Jobifyr. All rights reserved.</span>
      </div>
